...
<head>
    <meta charset="UTF-8">
    <title>Main</title>
    <link rel="stylesheet" href="src/main/webapp/css/main_screen.css">
    <link rel="stylesheet" href="src/main/webapp/css/main_logic_bar.css">
    <link rel="stylesheet" href="src/main/webapp/css/form_main.css">
    <style type="text/css">
        main {
            background: none;
            position: absolute;
...
<div class="navigation">
    ...
    <div class="menu">
        <c:if test="${requestScope.isAdmin == true}">
            ...
            <ul class="nav">
                <li><a class="link" href="src/main/webapp/index.jsp">Sign out</a></li>
            </ul>
        </c:if>
        ...
        <ul class="nav icon">
            ...
            <li><a class="link" href="profile"><img class="user" src="src/main/webapp/css/img/user.png" alt="user"></a></li>
        </ul>
    </div>
</div>
<c:if test="${requestScope.isAdmin == true}">
    <div class="logic_bar">
        ...
        <div class="logic_menu">
            ...
            <ul class="logic_nav logic_icon">
                ...
                <li><a class="link" href="src/main/webapp/index.jsp">Sort</a></li>
            </ul>
        </div>
    </div>
</c:if>
